...
config_paths = [
    "/mnt/d/Workspace/Networks/RL-Project/ns-o-ran-gym/dev/sim_config/scenario_configurations_eval_106/eval_106_500_0_0_0.json",
    "/mnt/d/Workspace/Networks/RL-Project/ns-o-ran-gym/dev/sim_config/scenario_configurations_eval_106/eval_106_500_1_0_0.json",    
    "/mnt/d/Workspace/Networks/RL-Project/ns-o-ran-gym/dev/sim_config/scenario_configurations_eval_106/eval_106_500_2_0_0.json",
    "/mnt/d/Workspace/Networks/RL-Project/ns-o-ran-gym/dev/sim_config/scenario_configurations_eval_106/eval_106_500_3_0_0.json",
    "/mnt/d/Workspace/Networks/RL-Project/ns-o-ran-gym/dev/sim_config/scenario_configurations_eval_106/eval_106_500_0_0_1.json",
    "/mnt/d/Workspace/Networks/RL-Project/ns-o-ran-gym/dev/sim_config/scenario_configurations_eval_106/eval_106_500_1_0_1.json",    
    "/mnt/d/Workspace/Networks/RL-Project/ns-o-ran-gym/dev/sim_config/scenario_configurations_eval_106/eval_106_500_2_0_1.json",
    "/mnt/d/Workspace/Networks/RL-Project/ns-o-ran-gym/dev/sim_config/scenario_configurations_eval_106/eval_106_500_3_0_1.json",
]
...
if __name__ == "__main__":
    save_callback = SaveEveryNTimestepsCallback(save_freq=10, save_path="./ppo-5-checkpoints")
    env_fns = [make_env(config_paths[i], ns3_path, output_folder, optimized, obs_mean, obs_std) for i in range(num_envs)]
    vec_env = SubprocVecEnv(env_fns)

    # Load model from checkpoint 
    log_dir = "./ppo-5-tensorboard"
    model = PPO.load(
        "./ppo-checkpoints/ppo_step_680", 
        env=vec_env, 
    ...
    new_logger = configure("./ppo-5-logs", ["stdout", "csv", "tensorboard"])
