...
if __name__ == "__main__":
    save_callback = SaveEveryNTimestepsCallback(save_freq=10, save_path="./ppo-mb-20-checkpoints")
    ...
    log_dir = "./ppo-mb-20-tensorboard"
    model = PPO.load(
        "./ppo-mb-20-checkpoints/ppo_step_160", 
        env=vec_env, 
    ...
    new_logger = configure("./ppo-mb-20-logs", ["stdout", "csv", "tensorboard"])
