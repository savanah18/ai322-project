...
BASE_DIR = f"/mnt/d/Workspace/Networks/RL-Project/ns-o-ran-gym" # CHANGE THIS TO YOUR BASE GIT REPO DIRECTORY
...
config_paths = [
    f"{BASE_DIR}/dev/sim_config/scenario_configurations_eval_111/eval_111_500_0_0_0.json",
    f"{BASE_DIR}/dev/sim_config/scenario_configurations_eval_111/eval_111_500_1_0_0.json",    
    f"{BASE_DIR}/dev/sim_config/scenario_configurations_eval_111/eval_111_500_2_0_0.json",
    f"{BASE_DIR}/dev/sim_config/scenario_configurations_eval_111/eval_111_500_3_0_0.json",
    f"{BASE_DIR}/dev/sim_config/scenario_configurations_eval_111/eval_111_500_0_0_1.json",
    f"{BASE_DIR}/dev/sim_config/scenario_configurations_eval_111/eval_111_500_1_0_1.json",    
    f"{BASE_DIR}/dev/sim_config/scenario_configurations_eval_111/eval_111_500_2_0_1.json",
    f"{BASE_DIR}/dev/sim_config/scenario_configurations_eval_111/eval_111_500_3_0_1.json",
]

ns3_path = "/home/gagluba/ns-3-mmwave-oran/" # CHANGE THIS TO YOUR NS3 PATH
...
if __name__ == "__main__":
    save_callback = SaveEveryNTimestepsCallback(save_freq=10, save_path="./ppo-mb-21-checkpoints")
    ...
    log_dir = "./ppo-mb-21-tensorboard"
    policy_kwargs = dict(
        net_arch=[dict(pi=[256, 256, 256, 128, 128], vf=[256, 256, 128, 64])]
    )
    ...
    new_logger = configure("./ppo-mb-21-logs", ["stdout", "csv", "tensorboard"])
