...
if __name__ == "__main__":
    ...
    match TRAINING_MODE:
        case "offline":
            ...
            new_logger = configure("./dqn-10-logs", ["stdout", "csv", "tensorboard"])
            model.set_logger(new_logger)

            save_callback = SaveEveryNTimestepsCallback(save_freq=100, save_path="./dqn-10-checkpoints")
            model.learn(total_timesteps=100000, callback=save_callback)
        case "online":
            save_callback = SaveEveryNTimestepsCallback(save_freq=10, save_path="./dqn-10-eval-checkpoints")
            ...
            log_dir = "./dqn-10-eval-tensorboard"
            model = DQN.load(
            ...
            new_logger = configure("./dqn-10-eval-logs", ["stdout", "csv", "tensorboard"])
            model.set_logger(new_logger)
